...
if image is None:
    print(f"Error: {image_file} が見つかりません。")
    exit()
...
if ids is not None:
    ...
    for i in range(len(ids)):
        ...
        # マーカーの座標軸を描画
        cv2.drawFrameAxes(image, camera_matrix, dist_coeffs, rvecs[0], tvecs[0], marker_length / 2)
        ...
        """
# imageをedited_test.jpgとして保存
cv2.imwrite("edited_test.jpg", image)
# 処理結果を表示
